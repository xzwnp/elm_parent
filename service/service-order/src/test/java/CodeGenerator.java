...
public class CodeGenerator {
    public static void main(String[] args) {
        //更改项如下
        //需要被扫描的表
        String[] tableNames = {"order","order_food"};
        //只能获取getProperty到母工程路径,剩余需要自行拼凑
        String projectPath = System.getProperty("user.dir")+"\\"+"service"+"\\"+"service-order";
        System.out.println(projectPath);
        String url = "jdbc:mysql://localhost:3306/elm?serverTimezone=GMT%2B8";
